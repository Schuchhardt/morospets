...
const Contact = () => (
  <section id="contacto" className="py-20 md:py-28 bg-primary/5" aria-labelledby="contact-heading">
    <div className="container">
      <AnimateOnScroll className="max-w-2xl mx-auto text-center mb-12">
        <span className="text-sm font-semibold text-accent tracking-wide uppercase">Contacto</span>
        <h2 id="contact-heading" className="text-3xl md:text-4xl font-bold text-primary mt-3 mb-5">Contáctanos</h2>
      ...
      <AnimateOnScroll delay={0.15}>
        <div className="grid sm:grid-cols-3 gap-6 max-w-3xl mx-auto mb-10">
          <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="bg-card rounded-2xl p-6 border border-border text-center hover:shadow-lg transition-shadow duration-500 group">
          ...
          <a href="tel:+56988881125" className="bg-card rounded-2xl p-6 border border-border text-center hover:shadow-lg transition-shadow duration-500 group">
            <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4 group-hover:bg-primary/20 transition-colors">
          ...
          <a href="https://www.instagram.com/morospets/" target="_blank" rel="noopener noreferrer" className="bg-card rounded-2xl p-6 border border-border text-center hover:shadow-lg transition-shadow duration-500 group">
            <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4 group-hover:bg-primary/20 transition-colors">
