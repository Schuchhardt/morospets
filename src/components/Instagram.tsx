        ...
        <AnimateOnScroll className="max-w-xl mx-auto text-center">
          ...
          <div className="flex justify-center mb-8">
            <blockquote
              ...
              data-instgrm-permalink="https://www.instagram.com/p/DVzL9pfDnI8/?utm_source=ig_embed&utm_campaign=loading"
            ...
            >
              <div style={{ padding: "16px" }}>
                <a
                  href="https://www.instagram.com/p/DVzL9pfDnI8/?utm_source=ig_embed&utm_campaign=loading"
                  style={{
                    background: "#FFFFFF",
                    lineHeight: 0,
                    padding: "0 0",
                ...
                <p style={{ color: "#c9c8cd", fontFamily: "Arial,sans-serif", fontSize: "14px", lineHeight: "17px", marginBottom: 0, marginTop: "8px", overflow: "hidden", padding: "8px 0 7px", textAlign: "center" as const, textOverflow: "ellipsis", whiteSpace: "nowrap" as const }}>
                  <a
                    href="https://www.instagram.com/p/DVzL9pfDnI8/?utm_source=ig_embed&utm_campaign=loading"
                    ...
                    rel="noopener noreferrer"
                  >
                    Una publicación compartida por @morospets
                  </a>
                </p>
              </div>
            </blockquote>
